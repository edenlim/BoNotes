...
<template>
    ...
    >
        <div class="mx-auto pt-[1.5rem]">
            <!-- PDF SVG -->
            <svg v-if="fileType === '.pdf'" width="86" height="81" viewBox="0 0 86 81" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- TXT SVG -->
            <svg v-else width="86" height="81" viewBox="0 0 54 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Use your existing Vue Rating Component -->
        <Rating
